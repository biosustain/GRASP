classdef computeGibbsFreeEnergyRangesTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testComputeGibbsFreeEnergyRangesLinprog(testCase)
            ...
            testCase.verifyThat(DGr_rng, matlab.unittest.constraints.IsEqualTo(trueResDGr, ...
                'Within', matlab.unittest.constraints.RelativeTolerance(1e-4)))
            testCase.verifyThat(xrng, matlab.unittest.constraints.IsEqualTo(trueResMets, ...
                'Within', matlab.unittest.constraints.RelativeTolerance(1e-10)))
            testCase.verifyThat(vrng, matlab.unittest.constraints.IsEqualTo(trueResFluxes, ...
                'Within', matlab.unittest.constraints.RelativeTolerance(1e-4)))
        end
