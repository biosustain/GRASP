...
v(9,:) = r_r91([1.2*ones(1,size(x,2))],[m_m7],[1*ones(1,size(x,2))],[m_m20],model.rxnParams(9).kineticParams);
v(10,:) = r_r101([1*ones(1,size(x,2));1.8*ones(1,size(x,2))],[m_m5;m_m20],[1.2*ones(1,size(x,2));1*ones(1,size(x,2))],[m_m10;m_m15],model.rxnParams(10).kineticParams);
v(11,:) = r_r111([m_m8],model.rxnParams(11).kineticParams);
v(12,:) = r_r121([1*ones(1,size(x,2));1.2*ones(1,size(x,2))],[m_m9;m_m10],[1*ones(1,size(x,2));1.8*ones(1,size(x,2))],[m_m19;m_m20],model.rxnParams(12).kineticParams);
