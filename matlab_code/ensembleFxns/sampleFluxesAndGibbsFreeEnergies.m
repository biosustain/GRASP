...
thermoLB     = [ensemble.gibbsRanges(ensemble.idxNotExch,1);ensemble.DGrStdRange(:,1);ensemble.lnMetRanges(:,1)];
thermoUB     = [ensemble.gibbsRanges(ensemble.idxNotExch,2);ensemble.DGrStdRange(:,2);ensemble.lnMetRanges(:,2)];
